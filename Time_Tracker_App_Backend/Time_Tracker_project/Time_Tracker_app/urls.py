...
from .views import AngajatView, PontajView, TipZiView, StatusView, logare, pagina_protejata, utilizator_curent, logout_view, scan_fingerprint, start_enroll, enroll_status, get_pending_enroll, update_enroll_status, get_pending_delete, start_delete_fingerprint, update_delete_status, delete_status
